...
| 3 | [Mini LLM](upcoming-phases.md#phase-3-mini-llm) | Transformers combine attention, positional information, training loops, and sampling into a small language model. |
