    ...
    render(
      <MemoryRouter>
        <RecentArtifactsPanel
          artifacts={[
            { labId: "bpe-train", conceptId: "bpe", artifactPath: "artifacts/bpe.json", status: "ok", error: "", createdAt: "2026-05-27T11:00:00Z" } as unknown as LabRunArtifact & { createdAt: string }
          ]}
